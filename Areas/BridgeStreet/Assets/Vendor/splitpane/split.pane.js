...
(function ($) {
	...
	methods.init = function() {
		...
		setTimeout(function() {
			...
			// and triggering multiple resize events when model is being opened from an <a target="_blank"> .
	...
	methods.removeDragEvents = function() {
	...
	function setLeft(components, left) {
		jQuery(components.splitPane).trigger('dividerupdate', left);
	...
	function setRight(components, right) {
		jQuery(components.splitPane).trigger('dividerupdate', right);
